...
<div className='sm:flex sm:w-3/4 sm:py-1 sm:px-5 sm:float-left max-sm:flex max-sm:overflow-scroll max-sm:mr-5'>
...
<div className="w-1/4 m-auto float-right"> 
    <select className='lg:max-w-44 md:max-w-36 sm:max-w-20 max-w-16 mr-2'>
        <option>{"fddfdvfdhdfybgdfvdfugayiaeurfgdhfdgifduhgifdhgoiahgoiangongfguahgiahgfdjagvnfvnfjdkgidfgbi"}</option>
    </select>
</div>
    </div>
